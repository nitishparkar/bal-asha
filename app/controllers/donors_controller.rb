class DonorsController < ApplicationController
  ...
  private
    ...
    def donor_params
      params.require(:donor).permit(:first_name, :last_name, :gender, :date_of_birth, :donor_type, :status, :identification_type, :identification_no, :trust_no, :mobile, :telephone, :email, :address, :city, :pincode, :state, :country_code, :solicit, :contact_frequency, :preferred_communication_mode, :remarks)
    end
end
