...
the_answer_to_life_the_universe_and_everything.times do
  ...
  donor = Donor.new(first_name: full_name[0], last_name: full_name[1], gender: ['male', 'male', 'male', 'female', 'female', 'other', 'not_specified'].sample, donor_type: ['individual', 'company', 'trust', 'group_'].sample, level: ['general', 'vip'].sample, country_code: [Faker::Address.country], contact_frequency: ['once_in_15_days', 'once_in_30_days'].sample, preferred_communication_mode: ['call', 'sms', 'email', 'any'].sample, mobile: Faker::PhoneNumber.cell_phone, telephone: Faker::PhoneNumber.phone_number, address:Faker::Address.street_address , city: Faker::Address.city, pincode: Faker::Address.zip_code, state: Faker::Address.state, email: Faker::Internet.email, date_of_birth: Faker::Date.between(60.years.ago, 20.years.ago), remarks: Faker::Lorem.paragraph, solicit: ['no', 'yes'].sample)
